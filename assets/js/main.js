...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateProgressBar() {
    ...
    if (totalItems <= 4) {
      ...
      document.querySelectorAll(".sales__progress-fill").forEach((fill) => {
...
class FavoritesManager {
  ...
  getItemData(itemElement) {
    return {
      ...
      title:
        itemElement.querySelector(".sales__item-title")?.textContent ||
        "Без названия",
      price:
        itemElement.querySelector(".sales__item-price")?.textContent || "0 ₽",
      category:
        itemElement.querySelector(".sales__category")?.textContent || "",
  ...
  generateItemId(itemElement) {
    ...
    const title =
      itemElement.querySelector(".sales__item-title")?.textContent || "";
    const price =
      itemElement.querySelector(".sales__item-price")?.textContent || "";
