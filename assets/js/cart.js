        ...
        item.title
                ...
                <div class="card__grid-left-name">
                    ...
                    <p class="card__grid-name-category sales__category">
                        ${item.category} <span class="point">·</span> ${
        item.genre
      }
                    </p>
                </div>
            ...
            <div class="cart__grid-item-right">
                <div class="cart__grid-right-contols">
                    <div class="cart__grid-controls-amount">
                        ...
                        <div class="cart__grid-anount-input">${
                          item.quantity
                        }</div>
                ...
                <div class="cart__grid-item-price">${(
            ...
            <div class="cart__sidebar-order-inner">
                <div class="cart__sidebar-order-wrapper">
                    <div class="cart__sidebar-order-inner-sum">
                        ...
                        <div class="cart__sidebar-sum-price">${originalTotal.toLocaleString(
                          "ru-RU"
                        )} ₽</div>
                    </div>
                    <div class="cart__sidebar-order-inner-discount">
                        <div class="cart__sidebar-discount-text">Скидка</div>
                        <div class="cart__sidebar-discount-price">${discount.toLocaleString(
                          "ru-RU"
                        )} ₽</div>
                    </div>
                </div>
                <div class="cart__sidebar-order-total">
                    <div class="cart__sidebar-order-total-inner">
                        ...
                        <div class="cart__sidebar-order-total-price">${totalPrice.toLocaleString(
                          "ru-RU"
                        )} ₽</div>
                    </div>
...
function increaseQuantity(button) {
  ...
  if (itemIndex !== -1) {
    ...
    priceElement.textContent =
      (items[itemIndex].price * items[itemIndex].quantity).toLocaleString(
        "ru-RU"
      ) + " ₽";
...
function toggleFavorite(button) {
  ...
  if (itemIndex !== -1) {
    ...
    heartIcon.setAttribute(
      "fill",
      items[itemIndex].isFavorite ? "url(#heart-gradient)" : "#F7F7F7"
    );
  }
}
